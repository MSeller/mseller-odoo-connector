...
This foundation module exposes the configuration UI (email, password,
API key, environment) on res.company and ships a reusable Python
client (`MSellerClient`) that covers the full public e-CF API
surface: authentication, document submission, validation, single
status query and batch status query.
